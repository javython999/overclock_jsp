        ...
        <section id="content">
        	<div class="contentWrap">
        		...
        		<div class="btnBox">
        			...
        			<form class="nextBtn" action="/board/cpu/pagemove" method="get">
        		...
        		<div class="commentBox">
        			...
        			<c:if test="${!empty sessionScope.sessionID}">
        			<div>
        				<form method="post" action="/board/cpu/comment">
        			...
        			<div class="commentList clear">
        				...
        				<div class="comment">
        				<form action="/board/cpu/comment/delete" method="get" class="Target">
