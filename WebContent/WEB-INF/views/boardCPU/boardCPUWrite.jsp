      ...
      <section id="body">
        ...
        <section id="content">
        	...
        	<form method="post" action="write" />
        		<div class="conTitle">
        			<input class="articleTitle" type="text" name="title" placeholder="제목을 입력하세요">
        		</div>
        		<div class="conInfo">
        			<input type="hidden" name="writerId" valuse="${sessioScope.sessionID}"/>
        			<lable for="cpuSelect">CPU선택</lable>
        			<select class="cpuSelector" name="CPU" id="cpuSelect">
	        			<optgroup label="인텔">
        	...
        	<div class="btnBox">
        		<button><a class="cancleBtn" href="/board/cpu/list">취소</a></button>
        		<input type="submit" value="등록" onclick="return checkValue();"/>
        	</div>
        	</form>
        </section>
      </section>
