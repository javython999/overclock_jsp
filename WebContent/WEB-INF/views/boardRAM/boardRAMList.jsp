...
<head>
<meta charset="UTF-8">
<link href="${pageContext.request.contextPath}/style/boardList.css" rel="stylesheet" />
    ...
    <div id="wrapper">
      ...
      <section id="body">
        ...
        <section id="content">
        	...
        	<div class="writeBtn">
        		<c:if test="${!empty sessionScope.sessionID}">
        		<a href="/board/ram/write"><i class="fas fa-pen-square">글쓰기</i></a>
        		</c:if>
        	</div>
        	<div class="searchBox">
	        	<form>
						<select name="f">
							...
							<option ${(param.f == "ram")?"selected": "" } value="ram">RAM</option>
						</select> 
