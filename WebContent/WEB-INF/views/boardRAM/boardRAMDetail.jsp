...
<link href="${pageContext.request.contextPath}/style/boardDetail.css" rel="stylesheet" />
        	...
        	<div class="contentWrap">
        		...
        		<div class="articleBtn">
        			<c:if test="${sessionScope.sessionID == n.writerId}">
        				<a href="/board/ram/modify?id=${n.id}"><i class="fas fa-pen-nib">수정</i></a>
        				<a href="/board/ram/delete?id=${n.id}" onclick="return confirm('삭제하시겠습니까?')"><i class="fas fa-trash-alt">삭제</i></a>
        			</c:if>
        		</div>
        		<div class="btnBox">
        			...
        			<form class="prevBtn" action="/board/ram/pagemove" method="get">
        			...
        			<!-- 글 목록 버튼 -->
        			<a href="/board/ram/list"><i class="far fa-list-alt"></i></a>
        			<!-- 다음 글 버튼 -->
        		...
        		<div class="commentBox">
        			...
        			<div class="commentList clear">
        				...
        				<div class="comment">
        				<form action="/board/ram/comment/delete" method="get" class="Target">
