        ...
        <section id="content">
        	<div class="contentWrap">
        		...
        		<div class="btnBox">
        			...
        			<c:if test="${n.id > 1}">
        			<button class="prevBtn"><a href="/notice/detail?id=${n.id-1}">이전</a></button>
        			</c:if>
        			<c:if test="${n.id <= 1}">
        			<button class="prevBtn"><a onclick="alert('이전 글이 없습니다.');">이전</a></button>
        			</c:if>
        			<button class="listBtn"><a href="/notice/list">목록</a></button>
        			<c:if test="${n.id < lastId }">
        			<button class="nextBtn"><a href="/notice/detail?id=${n.id+1}">다음</a></button>
        			</c:if>
        			<c:if test="${n.id >= lastId }">
        		...
        		<div class="commentBox">
        			...
        			<div>
        				...
        				<div class="commentButton"><input type="submit" value="댓글수정" class="commentButton cmtBtn" onclick="checkValue();"></div>
        				</form>
        			</div>
        			</c:if>
        			...
        			<div class="commentList clear">
        				...
        				<div class="comment">
        				<form action="/notice/comment/delete" method="get" class="deletTarget">
