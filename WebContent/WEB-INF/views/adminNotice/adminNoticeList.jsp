...
<head>
<meta charset="UTF-8">
<link href="${pageContext.request.contextPath}/style/adminNoticeList.css" rel="stylesheet" />
    ...
    <div id="wrapper">
      ...
      <section id="body">
        ...
        <section id="content">
        	...
        	<form action="list" method="post" class="noticeControll">
        	...
        	<div class="noticeList">
        		...
        		<div>${n.writerId }</div>
        		<div><fmt:formatDate pattern="YYYY-MM-dd" value="${n.regdate }"/></div>
        		<div><fmt:formatNumber value="${n.hit }"/></div>
        		<c:set var="open" value=""/>
        		<c:if test="${n.pub}">
        			<c:set var="open" value="checked"/>
        		</c:if>
        		<div><i class="fas fa-lock-open"></i><input type="checkbox" name="open-id" ${open} value="${n.id}" /></div>
        		<div><i class="fas fa-trash-alt"></i><input type="checkbox" name="del-id"  value="${n.id}" /></div>
        	</div>
			</c:forEach>
        	</div>
        	<div class="adminMenu">
        		...
        		<button><a href="/admin/notice/write">글쓰기</a></button>
        	</div>
        	</form>
        	<div class="pager">
